...
from training.distributional.corpus_reader import CorpusReader
from training.distributional.common import save_gensim_vectors
...
def main():
    ...
    try:
        model = gensim.models.Word2Vec(sentence_iter,
